        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0" style="color: white"> Hi {{$admin->name}}, welcome back! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Your web analytics dashboard template.</span>
              </h3>
              <div class="d-flex">
                      ...
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Total Invested Money</p>
                            <h2 class="text-white"> ₹ {{$InvestedMoney}}<span class="h5">00</span>
                            </h2>
                          </div>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card grid-margin grid-margin-sm-0 pb-sm-3">
                    <div class="card bg-danger">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Total Stocks</p>
                            <h2 class="text-white"> {{$TotalStocks}}<span class="h5">00</span>
                            </h2>
                          </div>
                  ...
                  <div class="col-xl-12 col-md-6 stretch-card pb-sm-3 pb-lg-0">
                    <div class="card bg-success">
                      <div class="card-body px-3 py-4">
                        <div class="d-flex justify-content-between align-items-start">
                          <div class="color-card">
                            <p class="mb-0 color-card-head">Profits</p>
                            <h2 class="text-white">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-sm-7">
                        ...
                        <p class="text-muted"> Show overview JAN 2023 - PRESENT <a class="text-muted font-weight-medium pl-2" href="#"><u>See Details</u></a>
                        </p>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="card mb-6 mb-sm-0">
                          <div class="card-body py-3 px-6">
                            <p class="m-0 survey-head">Total Users</p>
                            <div class="d-flex justify-content-between align-items-end flot-bar-wrapper">
                              <div>
                                <h3 class="m-0 survey-value">USERS:{{$usersCounts}}</h3>
                                INVESTED USERS: <p class="text-success m-0">{{$INVESTEDusers}}</p>
                              </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4">
                        <p class="mb-0 text-muted">Sales Profit</p>
                        <h5 class="d-inline-block survey-value mb-0"> ₹ 10,000,000 </h5>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$user->invested_money}}</td>
                            <td>{{$user->stock_name}}</td>
                          </tr>        
                          @endforeach                 
                        </tbody>
                      </table>
                      ...
                      <div class="col-12 col-sm-7">
                        <div class="row">
                          <div class="col-4 col-md-4">
                            <img class="customer-img" src="https://test.pearl-developer.com/eskay/public/assets/admin/template/assets/images/unnamed.png" alt="" />
                          </div>
                        ...
                        <p class="text-muted">
                          ...
                          <span class="d-inline-block">
                            <span class="d-flex d-inline-block">
                              <img class="ml-1" src="{{asset('assets/admin/template/images/faces/face1.jpg')}}" alt="" />
                              <img class="ml-1" src="{{asset('assets/admin/template/images/faces/face10')}}" alt="" />
                              <img class="ml-1" src="{{asset('assets/admin/template/images/faces/face14.jpg')}}"alt="" />
                            </span>
                          </span>
                        </p>
                      </li>
                    ...
                    <div class="list-card">
                      <div class="row align-items-center">
                        <div class="col-7 col-sm-8">
                          <div class="row align-items-center">
                            <div class="col-sm-4">
                              <img src="https://test.pearl-developer.com/eskay/public/assets/admin/template/assets/images/unnamed.png" alt="">
                            </div>
