                            ...
                            <tbody>
                                 @foreach($stock as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ asset('stocks/' .$data->company_logo) }}" download="{{ $data->companylogo }}">
                                            <img src="{{ asset('stocks/' .$data->company_logo) }}" alt="image" style="width:100px; height:100px; border-radius:80%">
                                            </a>
                                        </td>
                                        <td>{{$data->company_symbol}}</td>
                                        ...
                                        <td class="d-flex"> 
                                           ...
                                           <a href="{{ route('admin.stocksdelete', $data->id) }}" class="btn btn-danger btn-sm danger-btn mr-2" onclick="return confirm('Are you sure you want to delete this plan?')">Delete</a>
